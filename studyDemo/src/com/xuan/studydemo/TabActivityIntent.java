...
import com.xuan.broadcast.activity_broadcast;
...
public class TabActivityIntent extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 private void setupViewComponent(){
	     ...
	     spec.setIndicator("listTest Demo"+getResources().
					getDrawable(android.R.drawable.ic_dialog_alert));
	     spec.setContent(it);
		 ...
		 it = new Intent();
		 it.setClass(TabActivityIntent.this,activity_broadcast.class);
		 spec = tabHost.newTabSpec("tab5");
	     spec.setIndicator("activity_broadcast  Demo"+getResources().
					getDrawable(android.R.drawable.ic_dialog_alert));
	     spec.setContent(it);
